...
namespace MinskTrans.Context
{
    ...
    public class BussnessLogic : GenericBussnessLogic
    {
        ...
        public BussnessLogic(IContext cont, UpdateManagerBase updateManager, InternetHelperBase internetHelper,
            FileHelperBase fileHelper, ISettingsModelView settings, IGeolocation geolocation, FilePathsSettings files,
...
*/
        ...
        public override async Task<bool> UpdateNewsTableAsync(CancellationToken token)
        {
            ...
            try
            {
                ...
                try
                {
                    ...
                    await
                        internetHelper.Download(files.LastUpdatedFile.SecondFormatedLink,
                            files.LastUpdatedFile.NewFileName,
            ...
            bool tryOnlyOriginalLink = false)
        {
            ...
            try
            {
                ...
                if (
                    await
                        Context.HaveUpdate(timeTable.Routs as IList<Rout>, timeTable.Stops as IList<Stop>,
